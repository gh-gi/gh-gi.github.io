// W3Schools fixed header on scroll, refer to https://www.w3schools.com/howto/howto_js_sticky_header.asp  
      ...
      function myFunction() {
        if (window.pageYOffset > sticky) {
          ...
          document.getElementById("content-container").style.paddingTop = "55px"; // adding code for padding equal to height of main-nav element to prevent page jumping on scroll 
        } else {
